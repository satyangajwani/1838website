...
import './globals.css';
import { bodoni, grotesque } from '@/lib/fonts';
...
export default function RootLayout({ children }: Readonly<{ children: React.ReactNode }>) {
  return <html lang="en" className={`${bodoni.variable} ${grotesque.variable}`}><body><FontGate />{children}<script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify(structuredData) }} /></body></html>;
}
